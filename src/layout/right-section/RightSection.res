...
let make = (
  ~completeState: (
    AsyncResult.t<Shape.Response.t, Error.t>,
    AsyncResult.t<Shape.Air.t, Error.t>,
    AsyncResult.t<Shape.UvIndex.t, Error.t>,
    AsyncResult.t<Shape.Forecast.t, Error.t>,
  ),
) => {
  ...
  | (_, _, _, Complete(Error(_))) =>
    <span className="text-danger"> {"Error occured. Please try again" |> React.string} </span>
  | (
